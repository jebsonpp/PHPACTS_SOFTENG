...
<body>
    <?php 
        ...
        if (isset($_GET['customer_id'])) {
            ...
            $getrecordbyid = getrecordbyid($pdo, $customer_id);
        } else {
            echo "No customer ID provided.";
            exit;
        }
    ?>
    <form action="core/handleForms.php?customer_id=<?php echo $customer_id; ?>" method="POST">
        <p>
        ...
        <p>
            <input type="submit" name="editSubmitBtn" value="Update Record">
        </p>
    </form>
</body>
</html>
